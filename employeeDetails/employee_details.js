const employees = [
  ...
  function findEmployeeBySpecialization() {
      ...
      if (foundEmployee) {
          document.getElementById('employeesDetails').innerHTML = `<p>${foundEmployee.id}: ${foundEmployee.name} - ${foundEmployee.department} - Specialization: ${foundEmployee.specialization}</p>`;
      } else {
